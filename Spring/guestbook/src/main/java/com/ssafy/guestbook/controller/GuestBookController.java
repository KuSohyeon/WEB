...
public class GuestBookController {
	...
	public String write(GuestBook guestBookDto, Model model, HttpSession session) {
	...
	public String list(@RequestParam Map<String, String> map, Model model) {
		...
		try {
			List<GuestBook> list = guestBookService.listArticle(map);
	...
	public String modify(@RequestParam("articleno") int articleno, Model model) {
		try {
			GuestBook guestBookDto = guestBookService.getArticle(articleno);
	...
	public String modify(GuestBook guestBookDto, Model model, HttpSession session) {
		Member memberDto = (Member) session.getAttribute("userinfo");
		if(memberDto != null) {
			guestBookDto.setUserid(memberDto.getUserid());
			try {
