...
<div class="container mx-auto">
	...
	<form method="post" action="${root}/main/save" id="productForm">

		<!--상품번호-->
		<div class="row form-group">
			<label for="no" class="col-3 pl-5"><span class="text-warning">*</span> 상품번호</label>
			<div class="col-9">
...
<script>
	$("#btnOk").click(function() {	
		if (formChk(['no', 'name']) == false) {
			return false;
		}
		$('#productForm').action="${root}/main/save";
		$('#productForm').submit();
	});
