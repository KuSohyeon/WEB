...
<div class="container mx-auto">
	...
	<!--도서정보입력 FORM 테이블시작//-->
	<form method="post" action="${root}/book/write" id="bookForm">
		...
		<div class="row form-group">
			...
			<div class="col-9">
				<input type="text" name="publish_date" id="publish_date" size='15'> 
			</div>			
		</div>		
		<!--출판사-->
		<div class="row form-group">
		...
		<div class="row bg-light mb-3 h50 align-items-center justify-content-center">
			<div class="col-4 text-center">
				<a href="#1" id="btnOk">
					<img src="../resources/ok.gif" width="64" height="29">
				</a>
				<a href="#1" id="btnReset">
					<img src="../resources/cancel.gif" width="64" height="29">
				</a>
			</div>
		</div>
	</form>
